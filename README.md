...
**A pipeline for processing, segmentating, and extracting features from .QPTIFF files generated by the Akoya PhenoCycler Fusion instrument, with AnnData exporting and cell phenotyping via Leiden clustering**

---

## Project Overview

This pipeline ingests QPTIFF images generated from Akoya's PhenoCycler Fusion instrument, processes them, segments the image, and extracts the cell features. It then saves the data in a .h5ad file and performs phenotyping analysis.
